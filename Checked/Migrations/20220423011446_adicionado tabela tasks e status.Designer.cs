...
namespace Checked.Migrations
{
    ...
    [Migration("20220423011446_adicionado tabela tasks e status")]
    partial class adicionadotabelatasksestatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Checked.Models.Models.Task", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Checked.Models.Statics.TP_TaskStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Checked.Models.Models.Task", b =>
                {
                    b.HasOne("Checked.Models.Statics.TP_TaskStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
